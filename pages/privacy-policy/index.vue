<template>
    <div class="privacy-policy">
        <header class="header">
            <h1>Privacy Policy for Oshirma!</h1>
            ...
            <div class="subsection">
                ...
                <ul>
                    ...
                    <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common
                        ...
                        authority.</li>
                    <li><strong>Application</strong> refers to Oshirma!, the software program provided by the Company.
                    </li>
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                        Agreement) refers to Oshirma!.</li>
                    ...
                    <li><strong>Usage Data</strong> refers to data collected automatically, either generated by the use
                        ...
                        visit).</li>
                    <li><strong>Website</strong> refers to Oshirma!, accessible from <a href="https://www.oshirma.uz/"
                            target="_blank">https://www.oshirma.uz/</a></li>
        ...
        <section class="section">
            ...
            <ul>
                <li>By email: <a href="mailto:oshirma.uz@gmail.com">oshirma.uz@gmail.com</a></li>
            </ul>
        </section>
