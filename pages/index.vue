    <template>
        <div
            ...
            <h4 class="font-bold font-chivo text-[14px] xl:text-heading-5 text-gray-500 mb-[70px]">We are building
                trailblazer app for food waste management in Uzbekistan </h4> <button type="button"> <a
                    ...
                    href="https://t.me/abdumajid_rashidov" target="_blank"><span
                        class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold">Connect
                        us</span><i> <img class="mr-4 rotate-180 filter-white w-[12px] group-hover:filter-black"
                            src="/assets/images/icons/icon-right.svg" alt="arrow right icon"></i></a></button>
        </div>
    </template>
<script setup>useHead({ bodyAttrs: { class: "overflow-x-hidden w-screen relative error-page" }, }) </script>